...
alusrc_expr = And(Not(s2), s1, Not(s0), 
    Or(
        And(op5, Not(op4), Not(op3), Not(op2), op1, op0), # LW (100011)
        And(op5, Not(op4), op3, Not(op2), op1, op0)      # SW (101011)
    )
)
